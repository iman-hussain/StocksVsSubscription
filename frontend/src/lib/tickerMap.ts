...
export const SUBSCRIPTION_TICKERS: TickerMapping[] = [
    ...
    { name: 'Amazon Prime', ticker: 'AMZN', defaultCost: 8.99, aliases: ['amazon prime', 'prime', 'prime membership', 'prime delivery'] },
    ...
    { name: 'Amazon Prime', ticker: 'AMZN', defaultCost: 14.99, aliases: ['amazon prime', 'prime', 'prime subscription'] },
...
export const PRODUCT_DATABASE: ProductMapping[] = [
    ...
    { name: 'Samsung Galaxy Tab S9 Ultra', ticker: 'SSNLF', rtp: 1199, releaseDate: '2023-08-11', aliases: ['tab s9 ultra', 's9 ultra', 'galaxy tab s9 ultra'] },
    { name: 'Samsung Galaxy Tab S9+', ticker: 'SSNLF', rtp: 999, releaseDate: '2023-08-11', aliases: ['tab s9+', 'tab s9 plus', 's9+', 's9 plus'] },
    { name: 'Samsung Galaxy Tab S9', ticker: 'SSNLF', rtp: 799, releaseDate: '2023-08-11', aliases: ['tab s9', 'galaxy tab s9'] },
    { name: 'Samsung Galaxy Tab S9 FE+', ticker: 'SSNLF', rtp: 599, releaseDate: '2023-10-16', aliases: ['tab s9 fe+', 's9 fe plus', 'fan edition'] },
    { name: 'Samsung Galaxy Tab S9 FE', ticker: 'SSNLF', rtp: 449, releaseDate: '2023-10-16', aliases: ['tab s9 fe', 's9 fe'] },

    // Galaxy Tab S8 Series
    { name: 'Samsung Galaxy Tab S8 Ultra', ticker: 'SSNLF', rtp: 1099, releaseDate: '2022-04-30', aliases: ['tab s8 ultra', 's8 ultra'] },
    { name: 'Samsung Galaxy Tab S8+', ticker: 'SSNLF', rtp: 899, releaseDate: '2022-04-30', aliases: ['tab s8+', 's8 plus'] },
    { name: 'Samsung Galaxy Tab S8', ticker: 'SSNLF', rtp: 699, releaseDate: '2022-04-30', aliases: ['tab s8', 'galaxy tab s8'] },

    // Galaxy Tab S7 Series
    { name: 'Samsung Galaxy Tab S7+', ticker: 'SSNLF', rtp: 849, releaseDate: '2020-08-21', aliases: ['tab s7+', 's7 plus'] },
    { name: 'Samsung Galaxy Tab S7', ticker: 'SSNLF', rtp: 649, releaseDate: '2020-08-21', aliases: ['tab s7', 'galaxy tab s7'] },
    { name: 'Samsung Galaxy Tab S7 FE', ticker: 'SSNLF', rtp: 529, releaseDate: '2021-05-27', aliases: ['tab s7 fe', 's7 fan edition'] },

    // Galaxy Tab A & Lite Series
    { name: 'Samsung Galaxy Tab A9+', ticker: 'SSNLF', rtp: 219, releaseDate: '2023-10-23', aliases: ['tab a9+', 'a9 plus', 'galaxy tab a9+'] },
    { name: 'Samsung Galaxy Tab A8', ticker: 'SSNLF', rtp: 229, releaseDate: '2022-01-17', aliases: ['tab a8', 'galaxy tab a8'] },
    { name: 'Samsung Galaxy Tab S6 Lite (2024)', ticker: 'SSNLF', rtp: 329, releaseDate: '2024-03-28', aliases: ['tab s6 lite 2024', 's6 lite refresh'] },
    { name: 'Samsung Galaxy Tab S6 Lite (2022)', ticker: 'SSNLF', rtp: 349, releaseDate: '2022-05-23', aliases: ['tab s6 lite 2022', 's6 lite'] },
    ...
    { name: 'Samsung Galaxy Z Fold 6', ticker: 'SSNLF', rtp: 1899, releaseDate: '2024-07-24', aliases: ['z fold 6', 'fold 6', 'z fold6', 'galaxy fold 6'] },
    { name: 'Samsung Galaxy Z Fold 5', ticker: 'SSNLF', rtp: 1799, releaseDate: '2023-08-11', aliases: ['z fold 5', 'fold 5', 'z fold5', 'galaxy fold 5'] },
    { name: 'Samsung Galaxy Z Fold 4', ticker: 'SSNLF', rtp: 1799, releaseDate: '2022-08-25', aliases: ['z fold 4', 'fold 4', 'z fold4', 'galaxy fold 4'] },
    { name: 'Samsung Galaxy Z Fold 3', ticker: 'SSNLF', rtp: 1799, releaseDate: '2021-08-27', aliases: ['z fold 3', 'fold 3', 'z fold3', 'galaxy fold 3'] },
    { name: 'Samsung Galaxy Z Fold 2', ticker: 'SSNLF', rtp: 1999, releaseDate: '2020-09-18', aliases: ['z fold 2', 'fold 2', 'z fold2', 'galaxy fold 2'] },

    // --- Samsung Smartphones: Standard (Galaxy S-Series) ---
    { name: 'Samsung Galaxy S24 Ultra', ticker: 'SSNLF', rtp: 1299, releaseDate: '2024-01-31', aliases: ['s24 ultra', 's24u'] },
    { name: 'Samsung Galaxy S24', ticker: 'SSNLF', rtp: 849, releaseDate: '2024-01-25', aliases: ['galaxy s24', 's24'] },
    { name: 'Samsung Galaxy S23 Ultra', ticker: 'SSNLF', rtp: 1199, releaseDate: '2023-02-17', aliases: ['s23 ultra', 's23u'] },
    { name: 'Samsung Galaxy S23', ticker: 'SSNLF', rtp: 799, releaseDate: '2023-02-17', aliases: ['s23', 'galaxy s23'] },
    { name: 'Samsung Galaxy S22 Ultra', ticker: 'SSNLF', rtp: 1199, releaseDate: '2022-02-25', aliases: ['s22 ultra', 's22u'] },
    { name: 'Samsung Galaxy S22', ticker: 'SSNLF', rtp: 799, releaseDate: '2022-02-25', aliases: ['s22', 'galaxy s22'] },
    { name: 'Samsung Galaxy S21 Ultra', ticker: 'SSNLF', rtp: 1199, releaseDate: '2021-01-29', aliases: ['s21 ultra', 's21u'] },
    { name: 'Samsung Galaxy S21', ticker: 'SSNLF', rtp: 799, releaseDate: '2021-01-29', aliases: ['s21', 'galaxy s21'] },
    { name: 'Samsung Galaxy S20', ticker: 'SSNLF', rtp: 999, releaseDate: '2020-03-06', aliases: ['s20', 'galaxy s20'] },
    { name: 'Samsung Galaxy S10', ticker: 'SSNLF', rtp: 899, releaseDate: '2019-03-08', aliases: ['s10', 'galaxy s10'] },
    ...
    { name: 'Samsung 990 Pro 2TB', ticker: 'SSNLF', rtp: 179, releaseDate: '2022-10-01', aliases: ['990 pro', 'samsung ssd', 'nvme ssd'] },
