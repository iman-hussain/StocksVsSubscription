/**
 * Backend presets data module.
 * Contains subscription, product, and habit presets for the StocksVsSubscription API.
 */
...
export interface TickerMapping {
	...
	category?: string; // Category for grouping (e.g., 'Streaming', 'Gaming', 'Music')
}
...
export const SUBSCRIPTION_TICKERS: TickerMapping[] = [
	// --- AI ---
	{ name: 'Copilot Pro', ticker: 'MSFT', defaultCost: 20.00, category: 'AI', aliases: ['copilot pro', 'microsoft copilot', 'copilot'] },
	{ name: 'Gemini Advanced', ticker: 'GOOGL', defaultCost: 18.99, category: 'AI', aliases: ['gemini advanced', 'google gemini', 'bard advanced'] },
	{ name: 'ChatGPT Plus', ticker: 'MSFT', defaultCost: 20.00, category: 'AI', aliases: ['chatgpt plus', 'chatgpt', 'openai', 'gpt-4', 'gpt4'] },

	// --- Bundles ---
	{ name: 'Apple One', ticker: 'AAPL', defaultCost: 19.95, category: 'Bundles', aliases: ['apple one', 'apple bundle'] },
	{ name: 'Google One', ticker: 'GOOGL', defaultCost: 18.99, category: 'Bundles', aliases: ['google one', 'google bundle'] },

	// --- Business ---
	{ name: 'Shopify', ticker: 'SHOP', defaultCost: 29.00, category: 'Business', aliases: ['shopify', 'shopify basic'] },
	{ name: 'Wix', ticker: 'WIX', defaultCost: 16.00, category: 'Business', aliases: ['wix', 'wix premium', 'wix website'] },
	{ name: 'GoDaddy', ticker: 'GDDY', defaultCost: 9.99, category: 'Business', aliases: ['godaddy', 'domain renewal', 'web hosting'] },
	{ name: 'Microsoft 365', ticker: 'MSFT', defaultCost: 5.99, category: 'Business', aliases: ['microsoft 365', 'office 365', 'm365', 'ms office', 'word', 'excel'] },
	{ name: 'Adobe Creative Cloud', ticker: 'ADBE', defaultCost: 59.99, category: 'Business', aliases: ['adobe creative cloud', 'adobe cc', 'creative cloud'] },
	{ name: 'Adobe Photoshop', ticker: 'ADBE', defaultCost: 19.99, category: 'Business', aliases: ['photoshop', 'adobe photoshop'] },
	{ name: 'Zoom', ticker: 'ZM', defaultCost: 12.99, category: 'Business', aliases: ['zoom', 'zoom pro', 'zoom meeting'] },
	{ name: 'Slack', ticker: 'CRM', defaultCost: 8.75, category: 'Business', aliases: ['slack', 'slack pro', 'slack premium'] },
	{ name: 'DocuSign', ticker: 'DOCU', defaultCost: 10.00, category: 'Business', aliases: ['docusign', 'electronic signature'] },
	{ name: 'LinkedIn Premium', ticker: 'MSFT', defaultCost: 39.99, category: 'Business', aliases: ['linkedin premium', 'linkedin learning', 'linkedin sales navigator'] },

	// --- Cloud ---
	{ name: 'Google Drive', ticker: 'GOOGL', defaultCost: 1.99, category: 'Cloud', aliases: ['google storage', 'google drive', 'gdrive'] },
	{ name: 'iCloud+', ticker: 'AAPL', defaultCost: 0.99, category: 'Cloud', aliases: ['icloud+', 'icloud plus', 'icloud', 'apple storage'] },
	{ name: 'Dropbox', ticker: 'DBX', defaultCost: 9.99, category: 'Cloud', aliases: ['dropbox', 'dropbox plus'] },

	// --- Dating ---
	{ name: 'Tinder', ticker: 'MTCH', defaultCost: 17.99, category: 'Dating', aliases: ['tinder', 'tinder gold', 'tinder plus', 'tinder platinum'] },
	{ name: 'Hinge', ticker: 'MTCH', defaultCost: 29.99, category: 'Dating', aliases: ['hinge', 'hinge preferred', 'hinge+'] },
	{ name: 'Bumble', ticker: 'BMBL', defaultCost: 29.99, category: 'Dating', aliases: ['bumble', 'bumble boost', 'bumble premium'] },
	{ name: 'Grindr', ticker: 'GRND', defaultCost: 19.99, category: 'Dating', aliases: ['grindr', 'grindr xtra', 'grindr unlimited'] },
	{ name: 'Match.com', ticker: 'MTCH', defaultCost: 34.99, category: 'Dating', aliases: ['match.com', 'match', 'match subscription'] },

	// --- Fitness ---
	{ name: 'Peloton App', ticker: 'PTON', defaultCost: 12.99, category: 'Fitness', aliases: ['peloton app', 'peloton digital', 'peloton membership'] },
	{ name: 'Planet Fitness', ticker: 'PLNT', defaultCost: 24.99, category: 'Fitness', aliases: ['planet fitness', 'pf black card', 'gym membership'] },
	{ name: 'Fitbit Premium', ticker: 'GOOGL', defaultCost: 9.99, category: 'Fitness', aliases: ['fitbit premium', 'fitbit'] },
	{ name: 'Gym', ticker: 'SPY', defaultCost: 45.00, category: 'Fitness', aliases: ['gym', 'gym membership', 'fitness center', 'health club', 'leisure centre'] },

	// --- Food ---
	{ name: 'HelloFresh', ticker: 'HFG', defaultCost: 50.00, category: 'Food', aliases: ['hellofresh', 'hello fresh', 'meal kit'] },

	// --- Gaming ---
	{ name: 'Twitch', ticker: 'AMZN', defaultCost: 3.99, category: 'Gaming', aliases: ['twitch', 'twitch turbo', 'twitch sub', 'twitch prime'] },
	{ name: 'Xbox Game Pass', ticker: 'MSFT', defaultCost: 10.99, category: 'Gaming', aliases: ['xbox game pass', 'game pass', 'gamepass', 'xgp', 'xbox live gold'] },
	{ name: 'PC Game Pass', ticker: 'MSFT', defaultCost: 9.99, category: 'Gaming', aliases: ['pc game pass', 'pc gamepass'] },
	{ name: 'PlayStation Plus', ticker: 'SONY', defaultCost: 10.99, category: 'Gaming', aliases: ['playstation plus', 'ps plus', 'ps+', 'ps now', 'playstation now'] },
	{ name: 'Nintendo Switch Online', ticker: 'NTDOY', defaultCost: 3.49, category: 'Gaming', aliases: ['nintendo switch online', 'switch online', 'nso', 'nintendo online'] },
	{ name: 'EA Play', ticker: 'EA', defaultCost: 4.99, category: 'Gaming', aliases: ['ea play', 'ea access', 'origin access'] },
	{ name: 'Ubisoft+', ticker: 'UBI', defaultCost: 14.99, category: 'Gaming', aliases: ['ubisoft+', 'ubisoft plus', 'uplay+'] },
	{ name: 'GTA+', ticker: 'TTWO', defaultCost: 5.99, category: 'Gaming', aliases: ['gta+', 'gta plus', 'rockstar social club'] },
	{ name: 'Roblox Premium', ticker: 'RBLX', defaultCost: 4.99, category: 'Gaming', aliases: ['roblox premium', 'roblox builders club', 'roblox'] },

	// --- Health ---
	{ name: 'WeightWatchers', ticker: 'WW', defaultCost: 23.00, category: 'Health', aliases: ['weightwatchers', 'weight watchers', 'ww'] },

	// --- Learning ---
	{ name: 'Duolingo Super', ticker: 'DUOL', defaultCost: 6.99, category: 'Learning', aliases: ['duolingo super', 'duolingo plus', 'duolingo'] },
	{ name: 'Coursera Plus', ticker: 'COUR', defaultCost: 59.00, category: 'Learning', aliases: ['coursera plus', 'coursera'] },
	{ name: 'Udemy Personal', ticker: 'UDMY', defaultCost: 29.99, category: 'Learning', aliases: ['learning personal', 'udemy'] },
	{ name: 'Chegg Study', ticker: 'CHGG', defaultCost: 15.95, category: 'Learning', aliases: ['chegg study', 'chegg'] },

	// --- Movies and TV ---
	{ name: 'Netflix', ticker: 'NFLX', defaultCost: 10.99, category: 'Movies and TV', aliases: ['netflix', 'net flix', 'netflix premium', 'netflix standard'] },
	{ name: 'Disney+', ticker: 'DIS', defaultCost: 7.99, category: 'Movies and TV', aliases: ['disney+', 'disney plus', 'disney', 'disney channel'] },
	{ name: 'Hulu', ticker: 'DIS', defaultCost: 7.99, category: 'Movies and TV', aliases: ['hulu', 'hulu+', 'hulu plus', 'hulu no ads'] },
	{ name: 'Prime Video', ticker: 'AMZN', defaultCost: 8.99, category: 'Movies and TV', aliases: ['prime video', 'amazon video', 'amazon prime video'] },
	{ name: 'Max', ticker: 'WBD', defaultCost: 9.99, category: 'Movies and TV', aliases: ['max', 'hbo max', 'hbo', 'warner bros discovery'] },
	{ name: 'Discovery+', ticker: 'WBD', defaultCost: 4.99, category: 'Movies and TV', aliases: ['discovery+', 'discovery plus', 'discovery channel'] },
	{ name: 'YouTube Premium', ticker: 'GOOGL', defaultCost: 12.99, category: 'Movies and TV', aliases: ['youtube premium', 'yt premium', 'youtube red', 'youtube no ads'] },
	{ name: 'Apple TV+', ticker: 'AAPL', defaultCost: 8.99, category: 'Movies and TV', aliases: ['apple tv+', 'apple tv plus', 'appletv', 'apple tv'] },
	{ name: 'Paramount+', ticker: 'PARA', defaultCost: 5.99, category: 'Movies and TV', aliases: ['paramount+', 'paramount plus', 'paramount'] },
	{ name: 'Peacock', ticker: 'CMCSA', defaultCost: 5.99, category: 'Movies and TV', aliases: ['peacock', 'peacock tv', 'nbc peacock'] },
	{ name: 'Now TV', ticker: 'CMCSA', defaultCost: 9.99, category: 'Movies and TV', aliases: ['now tv', 'nowtv', 'sky now'] },
	{ name: 'Roku Channel', ticker: 'ROKU', defaultCost: 0.00, category: 'Movies and TV', aliases: ['roku', 'roku channel', 'roku premium'] },

	// --- Music ---
	{ name: 'Spotify', ticker: 'SPOT', defaultCost: 10.99, category: 'Music', aliases: ['spotify', 'spotify premium', 'spotify duo', 'spotify family'] },
	{ name: 'YouTube Music', ticker: 'GOOGL', defaultCost: 10.99, category: 'Music', aliases: ['youtube music', 'yt music', 'google music'] },
	{ name: 'Apple Music', ticker: 'AAPL', defaultCost: 10.99, category: 'Music', aliases: ['apple music', 'itunes music'] },
	{ name: 'Pandora', ticker: 'SIRI', defaultCost: 4.99, category: 'Music', aliases: ['pandora', 'pandora plus', 'pandora premium'] },

	// --- News ---
	{ name: 'The New York Times', ticker: 'NYT', defaultCost: 17.00, category: 'News', aliases: ['nyt', 'new york times', 'ny times', 'nyt all access'] },
	{ name: 'Wall Street Journal', ticker: 'NWSA', defaultCost: 38.99, category: 'News', aliases: ['wsj', 'wall street journal', 'dow jones'] },

	// --- Pets ---
	{ name: 'BarkBox', ticker: 'BARK', defaultCost: 35.00, category: 'Pets', aliases: ['barkbox', 'bark box', 'dog box'] },

	// --- Podcasts ---
	{ name: 'SiriusXM', ticker: 'SIRI', defaultCost: 13.99, category: 'Podcasts', aliases: ['siriusxm', 'sirius xm', 'satellite radio', 'sirius'] },
	{ name: 'Audible', ticker: 'AMZN', defaultCost: 7.99, category: 'Podcasts', aliases: ['audible', 'amazon audible', 'audiobooks'] },

	// --- Shopping ---
	{ name: 'Amazon Prime', ticker: 'AMZN', defaultCost: 8.99, category: 'Shopping', aliases: ['amazon prime', 'prime', 'prime membership', 'prime delivery', 'prime subscription'] },
	{ name: 'Walmart+', ticker: 'WMT', defaultCost: 12.95, category: 'Shopping', aliases: ['walmart+', 'walmart plus', 'walmart delivery'] },
	{ name: 'Uber One', ticker: 'UBER', defaultCost: 9.99, category: 'Shopping', aliases: ['uber one', 'uber pass', 'uber eats pass', 'eats pass'] },
	{ name: 'DashPass', ticker: 'DASH', defaultCost: 9.99, category: 'Shopping', aliases: ['dashpass', 'dash pass', 'doordash'] },
	{ name: 'Deliveroo Plus', ticker: 'ROO', defaultCost: 3.49, category: 'Shopping', aliases: ['deliveroo plus', 'deliveroo gold', 'deliveroo'] },
	{ name: 'Instacart+', ticker: 'CART', defaultCost: 9.99, category: 'Shopping', aliases: ['instacart+', 'instacart plus', 'instacart express'] },
	{ name: 'Grubhub+', ticker: 'JET', defaultCost: 9.99, category: 'Shopping', aliases: ['grubhub+', 'grubhub plus', 'seamless+'] },

	// --- Social ---
	{ name: 'X Premium', ticker: 'TSLA', defaultCost: 8.00, category: 'Social', aliases: ['x premium', 'twitter blue', 'twitter premium', 'x basic'] },

	// --- Sports ---
	{ name: 'ESPN+', ticker: 'DIS', defaultCost: 10.99, category: 'Sports', aliases: ['espn+', 'espn plus', 'espn'] },

	// --- Utilities ---
	{ name: 'Ring Protect', ticker: 'AMZN', defaultCost: 4.99, category: 'Utilities', aliases: ['ring protect', 'ring plan', 'ring doorbell subscription'] },
	{ name: 'ADT Control', ticker: 'ADT', defaultCost: 28.99, category: 'Utilities', aliases: ['adt control', 'adt', 'adt security'] },
	{ name: 'Arlo Secure', ticker: 'ARLO', defaultCost: 12.99, category: 'Utilities', aliases: ['arlo secure', 'arlo', 'arlo subscription'] },
	{ name: 'Nest Aware', ticker: 'GOOGL', defaultCost: 8.00, category: 'Utilities', aliases: ['nest aware', 'nest subscription', 'google nest'] },
...
/**
 * Habit presets - recurring purchases like coffee, food, etc.
 */
export const HABIT_PRESETS: HabitMapping[] = [
	// --- Food & Drink ---
	{ name: "Morning Coffee", ticker: "SBUX", defaultFrequency: "daily", defaultCost: 3.50 },
	{ name: "Artisan Sourdough", ticker: "SPY", defaultFrequency: "weekly", defaultCost: 5.50 },
	{ name: "Daily Meal Deal", ticker: "TSCO.L", defaultFrequency: "workdays", defaultCost: 3.90 },
	{ name: "Starbucks Latte", ticker: "SBUX", defaultFrequency: "daily", defaultCost: 4.20 },
	{ name: "Dunkin Donuts", ticker: "DNUT", defaultFrequency: "weekly", defaultCost: 12.00 },
	{ name: "Big Mac Meal", ticker: "MCD", defaultFrequency: "weekly", defaultCost: 7.99 },
	{ name: "Burrito Bowl", ticker: "CMG", defaultFrequency: "weekly", defaultCost: 11.50 },
	{ name: "Pizza Night", ticker: "DPZ", defaultFrequency: "weekly", defaultCost: 25.00 },
	{ name: "Food Delivery Orders", ticker: "UBER", defaultFrequency: "weekly", defaultCost: 40.00 },
	{ name: "Pub Roast", ticker: "BUD", defaultFrequency: "weekly", defaultCost: 18.00 },
	{ name: "Weekend Brunch", ticker: "SPY", defaultFrequency: "weekly", defaultCost: 22.00 },
	{ name: "Energy Drink", ticker: "MNST", defaultFrequency: "daily", defaultCost: 2.50 },
	{ name: "Monster Energy", ticker: "MNST", defaultFrequency: "daily", defaultCost: 2.50 },
	{ name: "Soda Crate", ticker: "KO", defaultFrequency: "monthly", defaultCost: 15.00 },
	{ name: "Craft Beer Pack", ticker: "SAM", defaultFrequency: "weekly", defaultCost: 14.00 },

	// --- Vices & Indulgences ---
	{ name: "Pack of Cigarettes", ticker: "BTI", defaultFrequency: "daily", defaultCost: 14.50 },
	{ name: "Cigarettes (Pack of 20)", ticker: "PM", defaultFrequency: "daily", defaultCost: 15.00 },
	{ name: "Vape / Nicotine Pods", ticker: "PM", defaultFrequency: "weekly", defaultCost: 12.00 },
	{ name: "Zyn's", ticker: "PM", defaultFrequency: "daily", defaultCost: 6.00 },
	{ name: "Pint of Beer", ticker: "BUD", defaultFrequency: "weekly", defaultCost: 6.50 },
	{ name: "Bottle of Wine", ticker: "DEO", defaultFrequency: "weekly", defaultCost: 14.00 },
	{ name: "Cannabis / CBD", ticker: "MO", defaultFrequency: "weekly", defaultCost: 45.00 },
	{ name: "Gambling / Lottery", ticker: "FLTR.L", defaultFrequency: "weekly", defaultCost: 20.00 },
	{ name: "Luxury Skincare", ticker: "EL", defaultFrequency: "monthly", defaultCost: 85.00 },

	// --- Health & Fitness ---
	{ name: "Protein Shakes", ticker: "GNC", defaultFrequency: "monthly", defaultCost: 45.00 },
	{ name: "Pre-Workout", ticker: "SPY", defaultFrequency: "monthly", defaultCost: 35.00 },
	{ name: "Yoga Class", ticker: "LULU", defaultFrequency: "weekly", defaultCost: 15.00 },
	{ name: "Personal Trainer", ticker: "SPY", defaultFrequency: "weekly", defaultCost: 50.00 },
	{ name: "Vitamin Stack", ticker: "AAPL", defaultFrequency: "monthly", defaultCost: 30.00 },

	// --- Entertainment & Leisure ---
	{ name: "Cinema Tickets", ticker: "AMC", defaultFrequency: "monthly", defaultCost: 14.00 },
	{ name: "Concert Tickets", ticker: "LYV", defaultFrequency: "monthly", defaultCost: 80.00 },
	{ name: "Video Game Skins", ticker: "MSFT", defaultFrequency: "monthly", defaultCost: 20.00 },
	{ name: "Twitch Bits", ticker: "AMZN", defaultFrequency: "monthly", defaultCost: 10.00 },
];
